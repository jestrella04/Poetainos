...
<div id="comment-{{ $comment->id }}" class="d-flex comment">
    ...
    <div class="flex-grow-1 card">
        <div class="comment-body card-header">
            ...
            <div class="buttons d-flex justify-content-between stats">
                <span @class(['btn', 'btn-link', 'border', 'btn-xs', 'likeable', 'liked' => $liked > 0])
                ...
                @auth
                    <span class="btn btn-link border btn-xs badge-reply" data-wh-target="#reply-form-{{ $comment->id }}">
