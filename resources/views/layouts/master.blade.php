...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="preload" href="{{ Vite::asset('resources/images/logo.svg') }}" as="image">
        ...
        <link rel="alternate icon" href="{{ Vite::asset('resources/images/logo-32.png') }}" sizes="32x32" type="image/png">
        <link rel="stylesheet" href="{{ Vite::asset('resources/sass/app.scss') }}" type="text/css">
        <!-- PWA Support -->
        ...
        <meta property="twitter:image" content="@yield('meta.card', asset(Vite::asset('resources/images/cover.jpg')))">
