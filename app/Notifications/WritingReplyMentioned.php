...
class WritingReplyMentioned extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct(Reply $reply, User $user)
    {
        ...
        $this->notification = [
            ...
            'url' => route('writings.show', $this->reply->comment->writing) . '#comment-reply-' . $this->reply->id,
    ...
    {
        return [
            'writing_id' => $this->reply->comment->writing->id,
